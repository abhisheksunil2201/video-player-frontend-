...
import { Brightness2, PersonRounded, WbSunny } from "@material-ui/icons";
    ...
    >
      ...
      <div className="flex items-center">
        {theme ? (
          ...
          <Brightness2
            onClick={() => setTheme(!theme)}
            className="text-black-2 border-2 border-black-2 rounded-lg p-1 text-3xl mr-3 cursor-pointer transform rotate-180"
          />
        )}
        ...
        {user ? (
          <Link className="relative" to="/profile">
            ...
            <img
              className={`rounded-full w-7 h-7 lg:w-8 lg:h-8 mt-0.5 ${
                theme && "border-none"
              }`}
